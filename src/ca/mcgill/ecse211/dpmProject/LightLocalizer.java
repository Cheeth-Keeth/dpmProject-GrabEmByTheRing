...
public class LightLocalizer {
	...
	private static final int MOVE_SPEED = Project.MOVE_SPEED;
	...
	private static final Port portLine = Project.portLine;
	private static final SensorModes myLine = Project.myLine;
	private static final SampleProvider myLineSample = Project.myLineSample;
	private static final float[] sampleLine = Project.sampleLine;
	...
	static void lightLocalize(Odometer odometer, EV3LargeRegulatedMotor leftMotor, EV3LargeRegulatedMotor rightMotor)
		...
		if(Project.SC == 0) odometer.setXYT(TILE_SIZE, TILE_SIZE, 0);
		if(Project.SC == 1) odometer.setXYT(7*TILE_SIZE, TILE_SIZE, 270);
		if(Project.SC == 2) odometer.setXYT(7*TILE_SIZE, 7*TILE_SIZE, 180);
		if(Project.SC == 3) odometer.setXYT(TILE_SIZE, 7*TILE_SIZE, 90);
	}
