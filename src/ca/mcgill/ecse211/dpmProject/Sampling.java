...
public class Sampling implements Runnable{
	...
	public void run() {
		...
		while(sampleCount<4) {
		    ...
		    Project.myLineSample.fetchSample(Project.sampleLine, 0); //get the reading from the sensor
		    float read = Project.sampleLine[0]*1000;  //multiply the read by 1000 as suggested in the class slides
